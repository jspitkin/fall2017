...
Failed handshake
--------
In the 'failed_hash' directory is a copy of mySSL, but with a failed hash handshake. I added the string
"TRUDY" to the values hashed to show a change in one of the handshake messages from an intruder.