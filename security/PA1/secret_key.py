...
def main():
    ...
    create_substitution_tables(message)
...
def create_substitution_tables(message):
    # Create 8 tables that each map [0, 256] to a random value [0, 256]
    ...
    for table_index in range(MSG_LENGTH):
        ...
        for encrypt_table_index in range(256):
            inverted_table[ENCRYPT_SUB_TABLES[table_index][encrypt_table_index]] = encrypt_table_index
