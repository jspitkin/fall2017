...
def create_shared_key(conn_sock, request, registry):
    ...
    ticket_package = create_ticket_package(ALICE_ID, BOB_ID, K_AB, K_A, K_B, N_1)
...
def create_ticket_package(ALICE_ID, BOB_ID, K_AB, K_A, K_B, N_1):
